...
class HDRTools {
    ...
    static Rgbe2float(float32array,
    ...
    static readStringLine(uint8array, startIndex) {
        var line = "";
        var character = "";
 ...
 static GetCubeMapTextureData(buffer, size) {
    ...
    static RGBE_ReadPixels(uint8array, hdrInfo) {
     ...
     static RGBE_ReadPixels_RLE(uint8array, hdrInfo) {
    ...
    static RGBE_ReadPixels_NOT_RLE(uint8array, hdrInfo) {
